...
void PowerCombinerDesigner::MultistageWilkinson()
{
    ...
    QString PreviousNode;//Auxiliar variable for connecting the current stage to the previous one in the for loop
    ...
    if (Specs.Implementation == "Lumped LC" )//LC elements. Pi CLC equivalent of a lambda/4 line
    {
        ...
        Ground.setParams(QString("GND%1").arg(++NumberComponents[GND]), GND, vertical, posx, 60, "", "");
    ...
    for (int i = 0; i < Specs.Nstages; i++)
    {
        if (Specs.Implementation == "Lumped LC" )//LC elements. Pi CLC equivalent of a lambda/4 line
        {
             ...
             //Upper branch
              ...
              Lseries.setParams(QString("L%1").arg(++NumberComponents[Inductor]), Inductor, horizontal,
                                     posx, -75, QString("%1").arg(PreviousNode), QString("Nupper%1").arg(i));
              ...
              //Cshunt
              Cshunt.setParams(QString("C%1").arg(++NumberComponents[Capacitor]), Capacitor, vertical,
                                    posx, -50, QString("Nupper%1").arg(i), "gnd");
              Cshunt.val["C"] = num2str(C_, Capacitance);
              Components.append(Cshunt);

              Ground.setParams(QString("GND%1").arg(++NumberComponents[GND]), GND, vertical, posx, -10, "", "");
              Components.append(Ground);
              ...
              {//Connect the current section to the previous one
                  WI.setParams(Lseries.ID, 0, Nupper.ID, 0);
                  Wires.append(WI);
              }
              else
              {
              ...
              //Node
              Nupper.setParams(QString("N%1").arg(++NumberComponents[ConnectionNodes]),posx+50,-75);
              Nodes.append(Nupper);
              ...
              WI.setParams(Cshunt.ID, 1, Lseries.ID, 1);
              Wires.append(WI);
              ...
              Lseries.setParams(QString("L%1").arg(++NumberComponents[Inductor]), Inductor, horizontal,
                                posx, 75, QString("%1").arg(PreviousNode), QString("Nlower%1").arg(i));
              Lseries.val["L"] = num2str(L[i], Inductance);
              Components.append(Lseries);
              ...
              //Cshunt
              Cshunt.setParams(QString("C%1").arg(++NumberComponents[Capacitor]), Capacitor, vertical,
                                    posx, 100, QString("Nlower%1").arg(i), "gnd");
              Components.append(Cshunt);
              ...
              if (i > 0)
              {//Connect the current section to the previous one
                  WI.setParams(Lseries.ID, 0, Nlower.ID, 0);
                  Wires.append(WI);
              }
              else
              {//Connect to the common node
              ...
              //Node
              Nlower.setParams(QString("N%1").arg(++NumberComponents[ConnectionNodes]),posx+50,75);
              Nodes.append(Nlower);
        ...
        {//Ideal TL
            ...
            //Node
            Nupper.setParams(QString("N%1").arg(++NumberComponents[ConnectionNodes]), posx+50, -50);
            Nodes.append(Nupper);
            ...
            //Node
            Nlower.setParams(QString("N%1").arg(++NumberComponents[ConnectionNodes]), posx+50, 50);
            Nodes.append(Nlower);
        ...
        posx += 50;
        //Isolation resistor
        ComponentInfo Riso(QString("R%1").arg(++NumberComponents[Resistor]), Resistor, vertical, posx, 0,
                           QString("Nupper%1").arg(i), QString("Nlower%1").arg(i));
