...
void PowerCombinerDesigner::Lim_Eom() {
  ...
  ComponentInfo Ground1(QString("GND%1").arg(++NumberComponents[GND]), GND, 0,
                        260, -20, "", "");
  ...
  // Node
  NodeInfo N4(QString("N%1").arg(++NumberComponents[ConnectionNodes]), 200,
              100);
  Nodes.append(N4);
  ...
  // Node
  NodeInfo N5(QString("N%1").arg(++NumberComponents[ConnectionNodes]), 100,
              100);
  Nodes.append(N5);
  ...
  ComponentInfo Ground2(QString("GND%1").arg(++NumberComponents[GND]), GND, 0,
                        100, 200, "", "");
  ...
  ComponentInfo TermSpar4(QString("T%1").arg(++NumberComponents[Term]), Term,
                          180, -20, 100, "N6", "gnd");
